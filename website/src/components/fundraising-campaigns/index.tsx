...
const FundrasingCampaigns: React.FC<GivebutterCampaignProps> = async ({
  lang,
}) => {
  ...
  const {
    data: { fundraisingCampaignsHeading, fundraisingCampaignsLink },
  } = await query<GetFundraisingCampaignsQuery>({

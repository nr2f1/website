 ...
 * });
 */
export function useGetBoardMembersQuery(
  ...
  return Apollo.useQuery<GetBoardMembersQuery, GetBoardMembersQueryVariables>(
    GetBoardMembersDocument,
    options,
  );
}
export function useGetBoardMembersLazyQuery(
  ...
  return Apollo.useLazyQuery<
    GetBoardMembersQuery,
    GetBoardMembersQueryVariables
  >(GetBoardMembersDocument, options);
}
export function useGetBoardMembersSuspenseQuery(
...
export type GetBoardMembersQueryHookResult = ReturnType<
  typeof useGetBoardMembersQuery
>;
export type GetBoardMembersLazyQueryHookResult = ReturnType<
  typeof useGetBoardMembersLazyQuery
>;
export type GetBoardMembersSuspenseQueryHookResult = ReturnType<
  typeof useGetBoardMembersSuspenseQuery
>;
export type GetBoardMembersQueryResult = Apollo.QueryResult<
  GetBoardMembersQuery,
  GetBoardMembersQueryVariables
>;

...
export type GetHeaderQueryVariables = Types.Exact<{
  ...
  patientCountLinkId: Types.Scalars['String']['input'];
...
export const GetHeaderDocument = gql`
  ...
  patientCountLink: link(locale: $locale, id: $patientCountLinkId) {
    text {
      content
    }
    target {
 ...
 *      patientCountLinkId: // value for 'patientCountLinkId'

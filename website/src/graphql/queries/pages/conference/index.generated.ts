...
export type GetConferencePageQuery = { nextConferenceHeading: { content: string | null } | null, introParagraph: { content: { json: Document, links: { entries: { inline: Array<
            | { sys: { id: string } }
            | { sys: { id: string } }
            | { sys: { id: string } }
            | { sys: { id: string } }
           ...
           | null>, block: Array<
            ...
            | { sys: { id: string } }
            | { sys: { id: string } }
           | null> }, assets: { block: Array<{ url: string | null, title: string | null, width: number | null, description: string | null, contentType: string | null, sys: { id: string } } | null> } } } | null } | null, bookTicketsLink: { target: { url: string | null } | null, text: { content: string | null } | null } | null, infoParagraph: { content: { json: Document, links: { entries: { inline: Array<
            | { sys: { id: string } }
            | { sys: { id: string } }
            | { sys: { id: string } }
            | { sys: { id: string } }
           ...
           | null>, block: Array<
            ...
            | { sys: { id: string } }
            | { sys: { id: string } }
           | null> }, assets: { block: Array<{ url: string | null, title: string | null, width: number | null, description: string | null, contentType: string | null, sys: { id: string } } | null> } } } | null } | null, bookTicketsHeading: { content: string | null } | null, offerHeading: { content: string | null } | null, offerParagraphs: { content: { json: Document } | null } | null, sponsorshipHeading: { content: string | null } | null, sponsorshipParagraphs: { content: { json: Document } | null } | null, faqsHeading: { content: string | null } | null, accordionCollection: { items: Array<{ title: string | null, content: { json: Document } | null } | null> } | null, pastConferencesHeading: { content: string | null } | null, pastConferencesParagraphs: { content: { json: Document } | null } | null };

...
export type GetPrivacyPolicyPageQueryVariables = Exact<{
  locale?: string | null | undefined;
  privacyPolicyPageParagraphsId: string;
}>;


export type GetPrivacyPolicyPageQuery = { mainbody: { content: { json: Document } | null } | null };

...
export type GetSupportUsPageQueryVariables = Exact<{
  locale?: string | null | undefined;
  supportUsPageParagraphsId: string;
}>;


export type GetSupportUsPageQuery = { mainbody: { content: { json: Document } | null } | null };
